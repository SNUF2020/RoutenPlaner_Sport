...
// Source code based on dlg.krakow.pl code (copyright (c) 2011-2016, dlg.krakow.pl)
...
namespace RPS
{
    ...
    public class GpxPoint
    {
        ...
        // Additional extensions for RPS program - at wrong level!!! -> RPS code placed extensions at GPX property level... :-/
        
        public double? Road
        {
            get { return Properties_.GetValueProperty<double>("road"); }
            set { Properties_.SetValueProperty<double>("road", value); }
        }

        public double? Rought_Road
        {
            get { return Properties_.GetValueProperty<double>("way"); }
            set { Properties_.SetValueProperty<double>("way", value); }
        }

        public double? Path
        {
            get { return Properties_.GetValueProperty<double>("path"); }
            set { Properties_.SetValueProperty<double>("path", value); }
        }
    ...
    {
        // Additional extensions for RPS program - this would be the right place in the GPX code... -> need additional adaption in RPS code
        public double? RPS_Road
        {
            get { return Properties_.GetValueProperty<double>("Road"); }
            set { Properties_.SetValueProperty<double>("Road", value); }
        }

        public double? RPS_Rought_Road
        {
            get { return Properties_.GetValueProperty<double>("Rought_Road"); }
            set { Properties_.SetValueProperty<double>("Rought_Road", value); }
        }

        public double? RPS_Path
        {
            get { return Properties_.GetValueProperty<double>("Path"); }
            set { Properties_.SetValueProperty<double>("Path", value); }
        }
